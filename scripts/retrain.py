...
def main(_):
  ...
  with tf.Session(graph=graph) as sess:
    ...
    performance_dictionary = {"training": train_accuracy,
                              "validation": validation_accuracy,
                              "test": test_accuracy}
    filename = os.getcwd()+ '/logs/logs.txt' # HERE! possibly add model.summary() to the log file
    write_performance(filename, performance_dictionary, FLAGS.batch_size, FLAGS.how_many_training_steps)
